(function() {
	var support = { animations : Modernizr.cssanimations },
		...
		effectSel = document.getElementById( 'component' ).getAttribute( 'data-effect' ),
		component = document.getElementById( 'component' ),
		items = component.querySelector( 'ul.itemwrap' ).children,
		current = 0,
		itemsCount = items.length,
		nav = component.querySelector( 'nav' ),
		navNext = nav.querySelector( '.next-item' ),
		navPrev = nav.querySelector( '.prev-item' ),
		isAnimating = false;
	...
	function init() {
		...
		classie.addClass( component, effectSel );

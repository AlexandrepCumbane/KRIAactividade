$(document).ready(function(){
  $(".ps-prev").hover(function(){
    $(".ps-next").addClass("nextHover");
  },function(){
    $(".ps-next").removeClass("nextHover");
  });
  $(".ps-next").hover(function(){
    $(".ps-prev").addClass("prevHover");
  },function(){
    $(".ps-prev").removeClass("prevHover");
  });
});
